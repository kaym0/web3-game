...
interface ITradeskill {
    function getHourlyExperience(uint256 cid, uint256 skillId) external view returns (uint256);
    function getHourlyMaterials(uint256 cid, uint256 skillId) external view returns (uint256);
